...
class TblProduct extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['root', 'lft', 'rgt', 'lvl', 'icon_type', 'active', 'selected', 'disabled', 'readonly', 'visible', 'collapsed', 'movable_u', 'movable_d', 'movable_l', 'movable_r', 'removable', 'removable_all', 'parentid'], 'integer'],
           // [['lft', 'rgt', 'lvl', 'name'], 'required'],
            [['name'], 'required'],
            [['name'], 'string', 'max' => 60],
            [['icon', 'photo', 'document'], 'string', 'max' => 255],
        ];
    }
